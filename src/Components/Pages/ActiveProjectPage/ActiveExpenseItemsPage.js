    ...
    <PageWrapperComponent>
              ...
              <Row>
                <Col lg={6} md="auto" sm={8}>
                  <FloatingLabel
                    ...
                    className="mb-3"
                  >
                    <Form.Control type="number" placeholder="Iznos" required />
                  </FloatingLabel>
                </Col>
                <Col lg={6} md="auto" sm={8}>
                  <FloatingLabel
                    ...
                    className="mb-3"
                  >
                    <Form.Control type="date" placeholder="Datum" required />
                  </FloatingLabel>
                </Col>
              </Row>
              <Row>
                <Col lg={12} md="auto" sm={8}>
                  <FloatingLabel
                    ...
                    className="mb-3"
                  >
                    <Form.Control type="text" placeholder="Napomena" required />
                  </FloatingLabel>
                </Col>
              </Row>
            </Container>
      ...
      >
        <Form onSubmit={handleAddExpenseItem}>
          ...
          <Modal.Body>
            <Container>
              <p style={{ fontStyle: 'italic' }}>*Upišite naziv nove stavke </p>
                ...
                <div className="card mb-4">
                  <div className="card-body text-center">
                    ...
                    <p className="text-muted mb-4">
                      Baza za godinu: <strong>{items?.spreadsheetYear}</strong>
                    </p>
